...
// Mapea status del backend al label visual
...
// Convierte torneo del backend al formato que espera TournamentCard
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 3, flexWrap: 'wrap', gap: 2 }}>
          <Box>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 0.5 }}>
              ...
              <Chip
                label={`${tournaments.length} torneos`}
                size="small"
          ...
          {/* Solo ADMIN y STAFF pueden crear torneos */}
        ...
        <Paper elevation={0} sx={{ backgroundColor: 'rgba(42, 21, 32, 0.5)', border: '1px solid rgba(123, 30, 59, 0.2)', mb: 3 }}>
          <Tabs
            ...
            scrollButtons="auto"
            sx={{
              '& .MuiTab-root': { color: '#C4B0B8', textTransform: 'none', fontWeight: 500, '&.Mui-selected': { color: '#D4A84B' } },
              '& .MuiTabs-indicator': { backgroundColor: '#D4A84B' },
            }}
          >
